...
<div class="fixed pointer-events-none z-50  overflow-hidden top-0 left-0 w-screen
    h-svh p-3 xl:p-12 flex flex-col justify-end items-end">
    ...
    {@const tamanho = 20}
        ...
        text-static-white px-4  py-4 rounded-[12px] pointer-events-auto relative shadow-xl 
        ...
        out:flySlide={{ x: 1600, duration: 800,easing }}>
          ...
          <div class="flex flex-col max-w-[280px] gap-1 overflow-hidden">
